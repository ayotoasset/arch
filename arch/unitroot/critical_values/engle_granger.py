...
eg_cv = {
    'nc': {
        1: [[-2.56531, -3.96106, -36.61383, 0.0],
        ...
        5: [[-1.94129, -1.43667, -27.53483, 293.17833],
        ...
        10: [[-1.61694, -0.84612, -3.45254, 0.0],
    ...
    'c': {
        1: [[-3.42939, -9.04951, -38.65063, 299.81138],
        ...
        5: [[-2.86129, -5.14873, -12.36841, 0.0],
        ...
        10: [[-2.56689, -3.61099, -9.58876, 0.0],
    ...
    'ct': {
        1: [[-3.95786, -14.46375, -23.67354, 0.0],
    ...
    'ctt': {
        1: [[-4.37085, -19.2718, -60.57539, 0.0],
        ...
        5: [[-3.83175, -13.10296, -25.06855, 0.0],
        ...
        10: [[-3.55284, -10.54834, -15.4041, 0.0],
...
class EngleGrangerCV(object):
    def __getitem__(self, item):
        # item ['nc',10,3]
        if (len(item) != 3 or item[0] not in eg_cv.keys()
